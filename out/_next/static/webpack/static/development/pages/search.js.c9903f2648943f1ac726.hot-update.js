...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(SearchTags, [{
    ...
    value: function handleAddition(tag) {
      ...
      var ReactTags__selected = document.querySelectorAll(".ReactTags__selected");

      if (ReactTags__selected.childNodes.length > 0) {
        var clear = document.getElementById("clearTag");
        clear.classList.add('active');
      }
    }
...
//# sourceMappingURL=search.js.c9903f2648943f1ac726.hot-update.js.map