...
function (_Component) {
  ...
  function SearchViews() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "handleSearchViewActive", function (e) {
      ...
      var searchViewItemClass = document.getElementsByClassName("searchViews-item");
      var clear = document.getElementById("clearSearchView");

      for (var i = 0; i < searchViewItemClass.length; i++) {
        if (searchViewItemClass[i].classList.contains('active')) {
          clear.classList.add('active');
        } else if (searchViewItemClass[1].classList.contains('active')) {
          clear.classList.remove('active');
        } else if (searchViewItemClass[2].classList.contains('active')) {
          clear.classList.remove('active');
        } else if (!searchViewItemClass[i].classList.contains('active')) {
          clear.classList.remove('active');
        }
      }
    });
...
//# sourceMappingURL=search.js.a0203d954d75d6977e33.hot-update.js.map