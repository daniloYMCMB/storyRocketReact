      ...
      <div className="searchViews">
        ...
        <ul className="searchViews-items" id="SearchMaterialType">
            <li className="searchViews-item" id="searchViews-item" onClick={this.handleSearchViewActive}>
                <a >
                  <div className="icon mia">
                    <svg style={{width:50, borderRadius: 0, height: 70}} version="1.1"  viewBox="0 0 512 640">
                      <g>
            ...
            <li className="searchViews-item" id="searchViews-item3" onClick={this.handleSearchViewActive3}>
                <a>
                  <div className="icon mia">
                    <svg style={{width:37, borderRadius: 0, height: 60}} viewBox="0 0 512.017 512.017">
